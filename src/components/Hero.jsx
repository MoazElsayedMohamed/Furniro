...
const Hero = () => {
  return (
    <section className="hero ">
      <div className="absolute bg-[#fff3e3] w-[50%] right-[4rem] top-[25rem] p-16 sm:max-xl:top-[1rem] sm:max-xl:right-[2rem] sm:max-md:w-[75%] sm:max-xl:p-8 md:max-xl:w-[60%] sm-tablet:max-xl:top-[7rem] lg:max-sm-tablet:top-[4rem] lg:max-sm-tablet:w-[70%] ">
